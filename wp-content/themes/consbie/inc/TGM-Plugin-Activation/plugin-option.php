	...
	$root = 'http://jwsuperthemes.com/plugins/';
       $plugins = array(       
        ...
        array(
		    ...
		    'source' => $root . 'elementor-extras.zip',
			'required' => true,
		),
        array(
			'name' => 'AnyWhere Elementor Pro',
			'slug' => 'anywhere-elementor-pro',
		    'source' => $root . 'anywhere-elementor-pro.zip',
			'required' => true,
		),
        array(
			'name' => 'Elementor Pro',
        ...
        array(
			'name' => 'Elementor Hello World',
			'slug' => 'elementor-hello-world',
		    'source' => $root . 'consbie/elementor-hello-world-master.zip',
			'required' => true,
		),
        array(
    		'name' => 'Consbie Core',
    		'slug' => 'consbie-core',
    		'source' =>  $root . 'consbie_core.zip',
    		'required' => true,
		),
        array(
            'name'               => 'Contact Form 7',
        ...
        array(
            'name'              => 'CMB2 Field Type: Font Awesome',
