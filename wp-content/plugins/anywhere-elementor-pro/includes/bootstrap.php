...
class Aepro{
    ...
    private function __construct() {
        ...
        add_action( 'elementor/dynamic_tags/register_tags', [$this, 'ae_dynamic_registered']);
    ...
    public function ae_dynamic_registered($dynamic_tags){
	    if(class_exists('acf')) {
		    include_once( AE_PRO_PATH . '/includes/elements/ae-dynamic/ae-dynamic-helper.php' );
		    include_once( AE_PRO_PATH . '/includes/elements/ae-dynamic/ae-text-dynamic.php' );
		    include_once( AE_PRO_PATH . '/includes/elements/ae-dynamic/ae-option-dynamic.php' );
		    include_once( AE_PRO_PATH . '/includes/elements/ae-dynamic/ae-url-dynamic.php' );
		    include_once( AE_PRO_PATH . '/includes/elements/ae-dynamic/ae-image-dynamic.php' );
		    include_once( AE_PRO_PATH . '/includes/elements/ae-dynamic/ae-gallery-dynamic.php' );
		    include_once( AE_PRO_PATH . '/includes/elements/ae-dynamic/ae-boolean-dynamic.php' );
		    if ( ! is_plugin_active( 'elementor-pro/elementor-pro.php' ) ) {
			    Plugin::$instance->dynamic_tags->register_group( 'acf', [
				    'title' => 'ACF'
			    ] );
		    }
		    $dynamic_tags->register_tag( AE_Text_Dynamic::class );
		    $dynamic_tags->register_tag( AE_Option_Dynamic::class );
		    $dynamic_tags->register_tag( AE_URL_Dynamic::class );
		    $dynamic_tags->register_tag( AE_Image_Dynamic::class );
		    $dynamic_tags->register_tag( AE_Gallery_Dynamic::class );
		    $dynamic_tags->register_tag( AE_Boolean_Dynamic::class );
	    }
    }
   ...
   public function set_custom_edit_ae_global_templates_posts_columns($columns) {
    ...
    public function elementor_widget_registered()
    {
        ...
        if(class_exists('acf')) {
            require_once AE_PRO_PATH . 'includes/elements/Skins/acf-repeater/skin-base.php';
            require_once AE_PRO_PATH . 'includes/elements/Skins/acf-repeater/skin-tabs.php';
            require_once AE_PRO_PATH . 'includes/elements/Skins/acf-repeater/skin-accordion.php';
