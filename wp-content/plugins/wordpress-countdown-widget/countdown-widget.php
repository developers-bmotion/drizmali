...
<script>(function($) { $(document).ready(function($) { var event_month = <?php echo $month; ?> - 1; desc = '<?php echo $event_display; ?>'; eventDate = new Date(<?php echo $year; ?>, event_month, <?php echo $day; ?>, <?php echo $hour; ?>, <?php echo $minutes; ?>, <?php echo $seconds; ?>, 0); $('#shailan-countdown-<?php echo $this->number . "_" . $countdown_shortcode_ids; ?>').countdown({ <?php if($direction == 'down'){ ?>until<?php } else { ?>since<?php } ?>: eventDate, description: desc, format: '<?php echo $format; ?>'<?php if($timezone != 'SCW_NONE'){ ?>, timezone: <?php echo $timezone; } ?> }); <?php if( $color != '' ){ ?> $('#shailan-countdown-<?php echo $this->number . "_" .$countdown_shortcode_ids; ?>').css('color', '<?php echo $color; ?>'); <?php } ?> <?php if( $bgcolor != '' ){ ?> $('#shailan-countdown-<?php echo $this->number . "_" . $countdown_shortcode_ids; ?>').css('backgroundColor', '<?php echo $bgcolor; ?>'); <?php } ?> $('.datepicker').datepicker({ dateFormat : 'dd-mm-yy' }); }); })(jQuery);</script>
		...
		<p><label for="<?php echo $this->get_field_id('event'); ?>"><?php _e('Event Title:', 'countdown-widget'); ?> <small><a href="https://metinsaylan.com/wordpress/plugins/countdown/help/#event-title" target="_blank" rel="external">(?)</a></small> <input class="widefat" id="<?php echo $this->get_field_id('event'); ?>" name="<?php echo $this->get_field_name('event'); ?>" type="text" value="<?php echo $event; ?>" /></label></p>
		...
		<p><label for="<?php echo $this->get_field_id('direction'); ?>"> <?php _e('Count Down/Up :', 'countdown-widget'); ?></label>
			...
			</select> <a href="https://metinsaylan.com/wordpress/plugins/countdown/help/#direction" target="_blank">(?)</a>
		</p>

		<p><label for="<?php echo $this->get_field_id('date'); ?>"><?php _e('Date :', 'countdown-widget'); ?></label> <small><a href="https://metinsaylan.com/wordpress/plugins/countdown/help/#date" target="_blank" rel="external">(?)</a></small> <input type="text" class="widefat datepicker" name="<?php echo $this->get_field_name('date'); ?>" id="<?php echo $this->get_field_id('date'); ?>" value="<?php echo $date; ?>"/><br />
		...
		<small>HH:MM:SS</small> <small><a href="https://metinsaylan.com/wordpress/plugins/countdown/help/#time" target="_blank" rel="external">(?)</a></small></p>

		<p><label for="<?php echo $this->get_field_id('format'); ?>"><?php _e('Format :', 'countdown-widget'); ?></label> <small><a href="https://metinsaylan.com/wordpress/plugins/countdown/help/#format" target="_blank" rel="external">(?)</a></small> <input id="<?php echo $this->get_field_id('format'); ?>" name="<?php echo $this->get_field_name('format'); ?>" class="widefat" type="text" value="<?php echo $format; ?>" size="10" maxlength="8" placeholder="yowdHMS" /><br />  </p>
		...
		<p><label for="<?php echo $this->get_field_id('timezone'); ?>"><?php _e('Timezone :', 'countdown-widget'); ?>
			...
			?>
			</select></label> <a href="https://metinsaylan.com/wordpress/plugins/countdown/help/#timezone" target="_blank">(?)</a></p>

		<p><label for="<?php echo $this->get_field_id('color'); ?>"><?php _e('Text Color :', 'countdown-widget'); ?></label> <small><a href="https://metinsaylan.com/wordpress/plugins/countdown/help/#color" target="_blank" rel="external">(?)</a></small> <input id="<?php echo $this->get_field_id('color'); ?>" name="<?php echo $this->get_field_name('color'); ?>" class="widefat" type="text"  placeholder="#000000" value="<?php echo $color; ?>" size="6" /></p>

		<p><label for="<?php echo $this->get_field_id('bgcolor'); ?>"><?php _e('Background Color :', 'countdown-widget'); ?></label> <small><a href="https://metinsaylan.com/wordpress/plugins/countdown/help/#background-color" target="_blank" rel="external">(?)</a></small> <input id="<?php echo $this->get_field_id('bgcolor'); ?>" name="<?php echo $this->get_field_name('bgcolor'); ?>" class="widefat" placeholder="#DDDDDD" type="text" value="<?php echo $bgcolor; ?>" size="6" /> </p>

		<p><label for="<?php echo $this->get_field_id('width'); ?>"><?php _e('Width :', 'countdown-widget'); ?> <input id="<?php echo $this->get_field_id('width'); ?>" name="<?php echo $this->get_field_name('width'); ?>" type="text" value="<?php echo $width; ?>" size="4" maxlength="4" /> px</label> <small><a href="https://metinsaylan.com/wordpress/plugins/countdown/help/#width" target="_blank" rel="external">(?)</a></small></p>

		<p><label for="<?php echo $this->get_field_id('radius'); ?>"><?php _e('Border Radius :', 'countdown-widget'); ?> <input id="<?php echo $this->get_field_id('radius'); ?>" name="<?php echo $this->get_field_name('radius'); ?>" type="text" value="<?php echo $radius; ?>" size="4" maxlength="4" /> px</label> <small><a href="https://metinsaylan.com/wordpress/plugins/countdown/help/#border-radius" target="_blank" rel="external">(?)</a></small></p>
