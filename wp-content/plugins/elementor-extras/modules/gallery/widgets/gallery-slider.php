...
class Gallery_Slider extends Extras_Widget {
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' 	=> __( 'Preview Effects', 'elementor-extras' ),
				'tab' 		=> Controls_Manager::TAB_STYLE,
				'condition' => [
					'caption_type!' => '',
				],
		...
		$this->start_controls_section(
			...
			[
				'label' 	=> __( 'Thumbnails Effects', 'elementor-extras' ),
				'tab' 		=> Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_thumbnails!' => '',
				],
	...
	private function render_preview_items() {
		...
		foreach ( $gallery as $index => $item ) {
			...
			$caption 			= ImageModule::get_image_caption( $item['id'], $settings['caption_type'] );
			...
			?><<?php echo $slide_tag; ?> <?php echo $this->get_render_attribute_string( $slide_key ); ?>>
				<figure <?php echo $this->get_render_attribute_string( $media_key ); ?>>
