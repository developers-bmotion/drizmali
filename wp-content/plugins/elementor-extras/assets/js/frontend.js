	...
	var ee = { 
		...
		GallerySlider : function( $scope, $ ) {
			...
			ee.GallerySlider.onSlideChange = function() {
				if ( hasCarousel ) {
					swiperCarousel.slideTo( ee.GallerySlider.getActiveIndex() );
				}

				$thumbs.removeClass('is--active');
				$thumbs.eq( ee.GallerySlider.getActiveIndex() ).addClass('is--active');
			};
			...
			ee.GallerySlider.getActiveIndex = function() {
				return sliderSettings.element.loop ? swiperSlider.realIndex : swiperSlider.activeIndex;
			};
