...
function emd_lite_admin_enq($app,$hook){
	if(preg_match('/page_' . $app . '_settings$/',$hook) || preg_match('/page_' . $app . '_notify$/',$hook) || preg_match('/page_' . $app . '_forms$/',$hook) || (preg_match('/page_' . $app . '_shortcodes$/',$hook) && (!function_exists('emd_std_media_js') && !function_exists('emd_analytics_media_js')))){
