jQuery(document).ready(function($){
			...
			receive: function(e, ui) {
				...
				if(ui.item.hasClass('emdform-field-button')){
					...
					$.ajax({
						...
						cache: false,
						async: false,
						data: {action:'emd_form_builder_get_field',app:app,field:field,entity:entity,page:page,form_id:form_id,nonce:builder_vars.nonce},
	...
	$('.emd-form-builder-add-row').click(function(e){
		...
		$.ajax({
			...
			cache: false,
			async: false,
			data: {action:'emd_form_builder_get_row',app:app,entity:entity,nonce:builder_vars.nonce},
			success: function(response){
				if(response.success){
	...
	$('.emdform-hr-button').click(function(e){
		...
		$.ajax({
			...
			cache: false,
			async: false,
			data: {action:'emd_form_builder_get_hr',app:app,entity:entity,nonce:builder_vars.nonce},
			success: function(response){
				if(response.success){
	...
	$('#emd-form-save').click(function(e){
		...
		$.ajax({
			...
			cache: false,
			async: false,
			data: {action:'emd_form_builder_save_form',data:JSON.stringify($('#emd-form-builder-form').serializeArray()),nonce:builder_vars.nonce},
			success: function(response){
				if(response.success){
